...
let basket = {
	...
	renderProductInBasket(product) {
		...
		let productRow = `
				...
				<input class="product-remove-btn" data-id="${product.id}" type="image" src="img/promo/arrow_cancel.png" alt="arrow_cancel">
			</div>
		`;
    ...
    removeProductFromBasket(id) {
		//let cLp = document.getElement('.cart-list__product');
